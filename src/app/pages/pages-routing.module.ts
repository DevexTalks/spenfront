...
const routes:Routes = [
  {path:'home', component:PagesComponent,
    children:[
      ...
      {path:'dir-settings', component:DirSettingsComponent, data:{titulo: 'Directores'}},
      {path:'eje-settings', component:EjeSettingsComponent, data:{titulo: 'Ejecutivos'}},
      {path:'metapac-settings', component:MetapacSettingsComponent, data:{titulo: 'Meta PAC'}},
      {path:'nometapac-settings', component:NometapacSettingsComponent, data:{titulo: 'No Meta PAC'}},
      {path:'minpac-settings', component:MinpacSettingsComponent, data:{titulo: 'Minimo PAC'}},
      {path:'nominpac-settings', component:NominpacSettingsComponent, data:{titulo: 'No Minimo PAC'}},
